...
class TransactionDB implements TransactionDBFunctions {
  ...
  Future<void> addTransaction(TransactionModel value) async {
    ...
    // Convert the TransactionModel to a Map before inserting to MongoDB
    Map<String, dynamic> transactionMap = value.toJson(); // Assuming toJson() method exists in your TransactionModel

    // Insert the transaction to MongoDB
    insertDocument(transactionMap);
  }
